...
public class DbInitializer
{
    ...
    {
        // Get a service scope from our service provider
        // Create a scoped context using 'using' to ensure proper disposal when done.
    ...
    private static void SeedData(AuctionDbContext context)
    {
        ...
        // AddRange is a new EF feature that allows us to add multiple entities at once
        context.AddRange(auctions); 
        // SaveChanges will save all the entities we added to the context to the database
        context.SaveChanges(); 
    }
}
